...
namespace ЛАБА1
{
    public partial class SelectSpeciesForm : Form
    {
        ...
        private void InitializeComponent(List<Species> speciesList, string title)
        {
            ...
            var lblInfo = new Label { Text = "Выберите расу:", Location = new Point(10, 10), Width = 200 };
            ...
            var btnSelect = new Button { Text = "Выбрать", Location = new Point(120, 220), Width = 80 };
            var btnCancel = new Button { Text = "Отмена", Location = new Point(210, 220), Width = 80 };
            ...
            this.Controls.AddRange(new Control[] { lblInfo, listBoxSpecies, btnSelect, btnCancel });
        }
    }
}